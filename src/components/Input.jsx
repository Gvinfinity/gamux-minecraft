    ...
    return (
      <div className="relative w-5/6">
        <input
          ...
          className={clsx(
            'w-full bg-neutral-300 flex-1 px-4 pt-5 py-2 rounded-md outline-none focus:rounded-b-none focus:border-b-2 transition-all duration-75 focus:border-b-primary-800 peer',
            inputStyle,
            {
              'pr-11': type === 'password',
            }
